...
namespace LabPatterns
{
    ...
    {
        private static readonly UnitFactory<LightUnit> _lightUnitFactory = UnitFactory<LightUnit>.Instance;
        ...
        /// <summary>
        /// Вовзращает индекс в списке типов следующего для создания юнита.
        /// </summary>
